using AESGame.Views.Base.Utils;
...
namespace AESGame.Views.Base
{
    public partial class BaseDialogWindow : Window, IThemeSetter
    {
        ...
        public Grid ViIcon { get; private set; }
        ...
        public override void OnApplyTemplate()
        {
            ...
            ViIcon = this.GetRequiredTemplateChild<Grid>("ViIcon");
        ...
        {
            if (ViIcon != null) ViIcon.Visibility = Visibility.Hidden;
